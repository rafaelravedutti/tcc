  ...
  BH_FB:
    {
        ...
        if (gid_x < iter_width) {
            if (gid_y < iter_height) {
                float _tmp14 = 0.F;
                {
                    _tmp14 += 0.0289949998F * _smeminput[(int)threadIdx.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp14 += 0.103817999F * _smeminput[(int)threadIdx.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp14 += 0.223173007F * _smeminput[(int)threadIdx.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp14 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp14 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 1 * (int)blockDim.y < iter_height) {
                float _tmp15 = 0.F;
                {
                    _tmp15 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp15 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp15 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp15 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp15 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 2 * (int)blockDim.y < iter_height) {
                float _tmp16 = 0.F;
                {
                    _tmp16 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp16 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp16 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp16 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp16 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 3 * (int)blockDim.y < iter_height) {
                float _tmp17 = 0.F;
                {
                    _tmp17 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp17 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp17 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp17 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp17 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 4 * (int)blockDim.y < iter_height) {
                float _tmp18 = 0.F;
                {
                    _tmp18 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp18 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp18 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp18 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp18 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 5 * (int)blockDim.y < iter_height) {
                float _tmp19 = 0.F;
                {
                    _tmp19 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp19 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp19 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp19 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp19 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 6 * (int)blockDim.y < iter_height) {
                float _tmp20 = 0.F;
                {
                    _tmp20 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp20 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp20 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp20 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp20 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 7 * (int)blockDim.y < iter_height) {
                float _tmp21 = 0.F;
                {
                    _tmp21 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp21 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp21 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp21 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp21 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp36 = 0.F;
                {
                    _tmp36 += 0.0289949998F * _smeminput[(int)threadIdx.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp36 += 0.103817999F * _smeminput[(int)threadIdx.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp36 += 0.223173007F * _smeminput[(int)threadIdx.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp36 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp36 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp37 = 0.F;
                {
                    _tmp37 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp37 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp37 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp37 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp37 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp38 = 0.F;
                {
                    _tmp38 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp38 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp38 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp38 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp38 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp39 = 0.F;
                {
                    _tmp39 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp39 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp39 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp39 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp39 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp40 = 0.F;
                {
                    _tmp40 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp40 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp40 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp40 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp40 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp41 = 0.F;
                {
                    _tmp41 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp41 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp41 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp41 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp41 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp42 = 0.F;
                {
                    _tmp42 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp42 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp42 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp42 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp42 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp43 = 0.F;
                {
                    _tmp43 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp43 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp43 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp43 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp43 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
  ...
  BH_B:
    {
        ...
        if (gid_x < iter_width) {
            if (gid_y < iter_height) {
                float _tmp58 = 0.F;
                {
                    _tmp58 += 0.0289949998F * _smeminput[(int)threadIdx.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp58 += 0.103817999F * _smeminput[(int)threadIdx.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp58 += 0.223173007F * _smeminput[(int)threadIdx.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp58 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp58 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 1 * (int)blockDim.y < iter_height) {
                float _tmp59 = 0.F;
                {
                    _tmp59 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp59 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp59 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp59 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp59 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 2 * (int)blockDim.y < iter_height) {
                float _tmp60 = 0.F;
                {
                    _tmp60 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp60 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp60 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp60 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp60 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 3 * (int)blockDim.y < iter_height) {
                float _tmp61 = 0.F;
                {
                    _tmp61 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp61 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp61 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp61 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp61 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 4 * (int)blockDim.y < iter_height) {
                float _tmp62 = 0.F;
                {
                    _tmp62 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp62 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp62 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp62 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp62 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 5 * (int)blockDim.y < iter_height) {
                float _tmp63 = 0.F;
                {
                    _tmp63 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp63 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp63 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp63 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp63 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 6 * (int)blockDim.y < iter_height) {
                float _tmp64 = 0.F;
                {
                    _tmp64 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp64 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp64 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp64 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp64 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 7 * (int)blockDim.y < iter_height) {
                float _tmp65 = 0.F;
                {
                    _tmp65 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp65 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp65 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp65 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp65 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp80 = 0.F;
                {
                    _tmp80 += 0.0289949998F * _smeminput[(int)threadIdx.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp80 += 0.103817999F * _smeminput[(int)threadIdx.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp80 += 0.223173007F * _smeminput[(int)threadIdx.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp80 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp80 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp81 = 0.F;
                {
                    _tmp81 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp81 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp81 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp81 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp81 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp82 = 0.F;
                {
                    _tmp82 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp82 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp82 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp82 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp82 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp83 = 0.F;
                {
                    _tmp83 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp83 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp83 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp83 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp83 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp84 = 0.F;
                {
                    _tmp84 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp84 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp84 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp84 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp84 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp85 = 0.F;
                {
                    _tmp85 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp85 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp85 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp85 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp85 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp86 = 0.F;
                {
                    _tmp86 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp86 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp86 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp86 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp86 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
        ...
        if (gid_x < iter_width) {
            {
                float _tmp87 = 0.F;
                {
                    _tmp87 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp87 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp87 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp87 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
                }
                {
                    _tmp87 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
                }
  ...
  BH_NO:
    {
        ...
        __syncthreads();
        {
            float _tmp88 = 0.F;
            {
                _tmp88 += 0.0289949998F * _smeminput[(int)threadIdx.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp88 += 0.103817999F * _smeminput[(int)threadIdx.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp88 += 0.223173007F * _smeminput[(int)threadIdx.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp88 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp88 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp89 = 0.F;
            {
                _tmp89 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp89 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp89 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp89 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp89 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp90 = 0.F;
            {
                _tmp90 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp90 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp90 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp90 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp90 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp91 = 0.F;
            {
                _tmp91 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp91 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp91 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp91 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp91 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp92 = 0.F;
            {
                _tmp92 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp92 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp92 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp92 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp92 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp93 = 0.F;
            {
                _tmp93 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp93 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp93 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp93 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp93 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp94 = 0.F;
            {
                _tmp94 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp94 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp94 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp94 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp94 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
        ...
        }
        {
            float _tmp95 = 0.F;
            {
                _tmp95 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -3 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp95 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -2 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp95 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + -1 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp95 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 3][(int)threadIdx.x + 0 + 0];
            }
            {
                _tmp95 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 1 + 3][(int)threadIdx.x + 0 + 0];
            }
