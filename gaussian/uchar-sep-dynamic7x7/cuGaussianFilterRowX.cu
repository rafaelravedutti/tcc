...
__device__ __constant__ float _constmask_xX[1][7];
  ...
  BH_FB:
    {
        ...
        if (gid_x < iter_width) {
            if (gid_y < iter_height) {
                float _tmp24 = 0.F;
                {
                    _tmp24 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp24 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp24 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp24 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp24 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp24 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 1 * (int)blockDim.y < iter_height) {
                float _tmp25 = 0.F;
                {
                    _tmp25 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp25 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp25 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp25 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp25 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp25 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 2 * (int)blockDim.y < iter_height) {
                float _tmp26 = 0.F;
                {
                    _tmp26 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp26 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp26 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp26 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp26 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp26 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 3 * (int)blockDim.y < iter_height) {
                float _tmp27 = 0.F;
                {
                    _tmp27 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp27 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp27 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp27 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp27 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp27 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 4 * (int)blockDim.y < iter_height) {
                float _tmp28 = 0.F;
                {
                    _tmp28 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp28 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp28 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp28 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp28 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp28 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 5 * (int)blockDim.y < iter_height) {
                float _tmp29 = 0.F;
                {
                    _tmp29 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp29 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp29 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp29 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp29 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp29 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 6 * (int)blockDim.y < iter_height) {
                float _tmp30 = 0.F;
                {
                    _tmp30 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp30 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp30 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp30 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp30 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp30 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 7 * (int)blockDim.y < iter_height) {
                float _tmp31 = 0.F;
                {
                    _tmp31 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp31 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp31 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp31 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp31 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp31 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
  ...
  BH_B:
    {
        ...
        if (gid_y < iter_height) {
            float _tmp56 = 0.F;
            {
                _tmp56 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp56 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp56 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp56 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp56 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp56 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 1 * (int)blockDim.y < iter_height) {
            float _tmp57 = 0.F;
            {
                _tmp57 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp57 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp57 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp57 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp57 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp57 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 2 * (int)blockDim.y < iter_height) {
            float _tmp58 = 0.F;
            {
                _tmp58 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp58 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp58 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp58 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp58 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp58 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 3 * (int)blockDim.y < iter_height) {
            float _tmp59 = 0.F;
            {
                _tmp59 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp59 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp59 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp59 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp59 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp59 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 4 * (int)blockDim.y < iter_height) {
            float _tmp60 = 0.F;
            {
                _tmp60 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp60 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp60 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp60 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp60 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp60 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 5 * (int)blockDim.y < iter_height) {
            float _tmp61 = 0.F;
            {
                _tmp61 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp61 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp61 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp61 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp61 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp61 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 6 * (int)blockDim.y < iter_height) {
            float _tmp62 = 0.F;
            {
                _tmp62 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp62 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp62 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp62 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp62 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp62 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 7 * (int)blockDim.y < iter_height) {
            float _tmp63 = 0.F;
            {
                _tmp63 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp63 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp63 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp63 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp63 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp63 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
  ...
  BH_R:
    {
        ...
        if (gid_x < iter_width) {
            if (gid_y < iter_height) {
                float _tmp88 = 0.F;
                {
                    _tmp88 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp88 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp88 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp88 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp88 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp88 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 1 * (int)blockDim.y < iter_height) {
                float _tmp89 = 0.F;
                {
                    _tmp89 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp89 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp89 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp89 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp89 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp89 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 2 * (int)blockDim.y < iter_height) {
                float _tmp90 = 0.F;
                {
                    _tmp90 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp90 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp90 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp90 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp90 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp90 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 3 * (int)blockDim.y < iter_height) {
                float _tmp91 = 0.F;
                {
                    _tmp91 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp91 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp91 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp91 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp91 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp91 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 4 * (int)blockDim.y < iter_height) {
                float _tmp92 = 0.F;
                {
                    _tmp92 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp92 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp92 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp92 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp92 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp92 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 5 * (int)blockDim.y < iter_height) {
                float _tmp93 = 0.F;
                {
                    _tmp93 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp93 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp93 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp93 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp93 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp93 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 6 * (int)blockDim.y < iter_height) {
                float _tmp94 = 0.F;
                {
                    _tmp94 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp94 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp94 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp94 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp94 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp94 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
        ...
        if (gid_x < iter_width) {
            if (gid_y + 7 * (int)blockDim.y < iter_height) {
                float _tmp95 = 0.F;
                {
                    _tmp95 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp95 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp95 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp95 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp95 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
                {
                    _tmp95 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
                }
                {
  ...
  BH_L:
    {
        ...
        if (gid_y < iter_height) {
            float _tmp120 = 0.F;
            {
                _tmp120 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp120 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp120 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp120 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp120 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp120 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 1 * (int)blockDim.y < iter_height) {
            float _tmp121 = 0.F;
            {
                _tmp121 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp121 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp121 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp121 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp121 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp121 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 2 * (int)blockDim.y < iter_height) {
            float _tmp122 = 0.F;
            {
                _tmp122 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp122 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp122 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp122 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp122 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp122 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 3 * (int)blockDim.y < iter_height) {
            float _tmp123 = 0.F;
            {
                _tmp123 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp123 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp123 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp123 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp123 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp123 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 4 * (int)blockDim.y < iter_height) {
            float _tmp124 = 0.F;
            {
                _tmp124 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp124 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp124 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp124 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp124 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp124 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 5 * (int)blockDim.y < iter_height) {
            float _tmp125 = 0.F;
            {
                _tmp125 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp125 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp125 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp125 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp125 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp125 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 6 * (int)blockDim.y < iter_height) {
            float _tmp126 = 0.F;
            {
                _tmp126 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp126 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp126 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp126 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp126 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp126 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        if (gid_y + 7 * (int)blockDim.y < iter_height) {
            float _tmp127 = 0.F;
            {
                _tmp127 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp127 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp127 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp127 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp127 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp127 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
  ...
  BH_NO:
    {
        ...
        __syncthreads();
        {
            float _tmp128 = 0.F;
            {
                _tmp128 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp128 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp128 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp128 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp128 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp128 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp129 = 0.F;
            {
                _tmp129 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp129 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp129 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp129 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp129 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp129 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp130 = 0.F;
            {
                _tmp130 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp130 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp130 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp130 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp130 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp130 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp131 = 0.F;
            {
                _tmp131 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp131 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp131 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp131 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp131 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp131 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp132 = 0.F;
            {
                _tmp132 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp132 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp132 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp132 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp132 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp132 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp133 = 0.F;
            {
                _tmp133 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp133 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp133 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp133 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp133 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp133 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp134 = 0.F;
            {
                _tmp134 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp134 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp134 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp134 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp134 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp134 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
        ...
        }
        {
            float _tmp135 = 0.F;
            {
                _tmp135 += _constmask_xX[0][0] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp135 += _constmask_xX[0][1] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp135 += _constmask_xX[0][2] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp135 += _constmask_xX[0][3] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp135 += _constmask_xX[0][4] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
            {
                _tmp135 += _constmask_xX[0][5] * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 2 + 32];
            }
            {
