#ifndef _CUGAUSSIANBLURFILTERMASKCOLUMNGFCC_CU_
#define _CUGAUSSIANBLURFILTERMASKCOLUMNGFCC_CU_
...
extern "C" {
__global__ __launch_bounds__ (128*1) void cuGaussianBlurFilterMaskColumnGFCCKernel(uchar * __restrict__ iter, int iter_width, int iter_stride, const float * __restrict__ input, int input_width, int input_height, int input_stride, int bh_start_right, int bh_start_top, int bh_start_bottom, int bh_fall_back) {
...
#endif //_CUGAUSSIANBLURFILTERMASKCOLUMNGFCC_CU_
