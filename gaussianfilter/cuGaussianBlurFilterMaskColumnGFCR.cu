#ifndef _CUGAUSSIANBLURFILTERMASKCOLUMNGFCR_CU_
#define _CUGAUSSIANBLURFILTERMASKCOLUMNGFCR_CU_
...
extern "C" {
__global__ __launch_bounds__ (128*1) void cuGaussianBlurFilterMaskColumnGFCRKernel(uchar * __restrict__ iter, int iter_width, int iter_stride, const float * __restrict__ input, int input_width, int input_height, int input_stride, int bh_start_right, int bh_start_top, int bh_start_bottom, int bh_fall_back) {
        ...
        if (gid_x < iter_width) {
            {
                float _tmp0 = 0.F;
                {
                    int _gid_x1 = gid_x + 0;
                    int _gid_y1 = gid_y + -2;
                    while (_gid_y1 >= input_height)
                        _gid_y1 = _gid_y1 - input_height;
                    while (_gid_y1 < 0)
                        _gid_y1 = _gid_y1 + input_height;
                ...
                }
                {
                    int _gid_x2 = gid_x + 0;
                    int _gid_y2 = gid_y + -1;
                    while (_gid_y2 >= input_height)
                        _gid_y2 = _gid_y2 - input_height;
                    while (_gid_y2 < 0)
                        _gid_y2 = _gid_y2 + input_height;
                ...
                }
                {
                    int _gid_x3 = gid_x + 0;
                    int _gid_y3 = gid_y + 0;
                    while (_gid_y3 >= input_height)
                        _gid_y3 = _gid_y3 - input_height;
                    while (_gid_y3 < 0)
                        _gid_y3 = _gid_y3 + input_height;
                ...
                }
                {
                    int _gid_x4 = gid_x + 0;
                    int _gid_y4 = gid_y + 1;
                    while (_gid_y4 >= input_height)
                        _gid_y4 = _gid_y4 - input_height;
                    while (_gid_y4 < 0)
                        _gid_y4 = _gid_y4 + input_height;
                ...
                }
                {
                    int _gid_x5 = gid_x + 0;
                    int _gid_y5 = gid_y + 2;
                    while (_gid_y5 >= input_height)
                        _gid_y5 = _gid_y5 - input_height;
                    while (_gid_y5 < 0)
                        _gid_y5 = _gid_y5 + input_height;
        ...
        if (gid_x < iter_width) {
            {
                ...
                }
                {
                    ...
                    while (_gid_y10 < 0)
                        _gid_y10 = _gid_y10 + input_height;
                ...
                }
                {
                    ...
                    while (_gid_y11 < 0)
                        _gid_y11 = _gid_y11 + input_height;
...
#endif //_CUGAUSSIANBLURFILTERMASKCOLUMNGFCR_CU_
