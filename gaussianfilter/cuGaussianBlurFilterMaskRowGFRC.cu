#ifndef _CUGAUSSIANBLURFILTERMASKROWGFRC_CU_
#define _CUGAUSSIANBLURFILTERMASKROWGFRC_CU_
...
extern "C" {
__global__ __launch_bounds__ (128*1) void cuGaussianBlurFilterMaskRowGFRCKernel(float * __restrict__ iter, int iter_width, int iter_stride, const uchar * __restrict__ input, int input_width, int input_height, int input_stride, int bh_start_left, int bh_start_right, int bh_fall_back) {
...
#endif //_CUGAUSSIANBLURFILTERMASKROWGFRC_CU_
