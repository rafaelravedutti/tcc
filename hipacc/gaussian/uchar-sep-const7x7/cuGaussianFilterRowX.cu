  ...
  BH_FB:
    {
        ...
        if (gid_x < iter_width) {
            if (gid_y < iter_height) {
                float _tmp24 = 0.F;
                {
                    _tmp24 += 0.0289949998F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp24 += 0.103817999F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp24 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp24 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp24 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 1 * (int)blockDim.y < iter_height) {
                float _tmp25 = 0.F;
                {
                    _tmp25 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp25 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp25 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp25 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp25 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 2 * (int)blockDim.y < iter_height) {
                float _tmp26 = 0.F;
                {
                    _tmp26 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp26 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp26 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp26 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp26 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 3 * (int)blockDim.y < iter_height) {
                float _tmp27 = 0.F;
                {
                    _tmp27 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp27 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp27 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp27 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp27 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 4 * (int)blockDim.y < iter_height) {
                float _tmp28 = 0.F;
                {
                    _tmp28 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp28 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp28 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp28 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp28 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 5 * (int)blockDim.y < iter_height) {
                float _tmp29 = 0.F;
                {
                    _tmp29 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp29 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp29 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp29 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp29 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 6 * (int)blockDim.y < iter_height) {
                float _tmp30 = 0.F;
                {
                    _tmp30 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp30 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp30 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp30 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp30 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 7 * (int)blockDim.y < iter_height) {
                float _tmp31 = 0.F;
                {
                    _tmp31 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp31 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp31 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp31 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp31 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
  ...
  BH_B:
    {
        ...
        if (gid_y < iter_height) {
            float _tmp56 = 0.F;
            {
                _tmp56 += 0.0289949998F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp56 += 0.103817999F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp56 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp56 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp56 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 1 * (int)blockDim.y < iter_height) {
            float _tmp57 = 0.F;
            {
                _tmp57 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp57 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp57 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp57 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp57 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 2 * (int)blockDim.y < iter_height) {
            float _tmp58 = 0.F;
            {
                _tmp58 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp58 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp58 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp58 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp58 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 3 * (int)blockDim.y < iter_height) {
            float _tmp59 = 0.F;
            {
                _tmp59 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp59 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp59 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp59 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp59 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 4 * (int)blockDim.y < iter_height) {
            float _tmp60 = 0.F;
            {
                _tmp60 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp60 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp60 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp60 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp60 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 5 * (int)blockDim.y < iter_height) {
            float _tmp61 = 0.F;
            {
                _tmp61 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp61 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp61 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp61 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp61 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 6 * (int)blockDim.y < iter_height) {
            float _tmp62 = 0.F;
            {
                _tmp62 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp62 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp62 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp62 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp62 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 7 * (int)blockDim.y < iter_height) {
            float _tmp63 = 0.F;
            {
                _tmp63 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp63 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp63 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp63 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp63 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
  ...
  BH_R:
    {
        ...
        if (gid_x < iter_width) {
            if (gid_y < iter_height) {
                float _tmp88 = 0.F;
                {
                    _tmp88 += 0.0289949998F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp88 += 0.103817999F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp88 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp88 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp88 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 1 * (int)blockDim.y < iter_height) {
                float _tmp89 = 0.F;
                {
                    _tmp89 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp89 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp89 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp89 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp89 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 2 * (int)blockDim.y < iter_height) {
                float _tmp90 = 0.F;
                {
                    _tmp90 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp90 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp90 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp90 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp90 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 3 * (int)blockDim.y < iter_height) {
                float _tmp91 = 0.F;
                {
                    _tmp91 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp91 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp91 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp91 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp91 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 4 * (int)blockDim.y < iter_height) {
                float _tmp92 = 0.F;
                {
                    _tmp92 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp92 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp92 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp92 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp92 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 5 * (int)blockDim.y < iter_height) {
                float _tmp93 = 0.F;
                {
                    _tmp93 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp93 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp93 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp93 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp93 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 6 * (int)blockDim.y < iter_height) {
                float _tmp94 = 0.F;
                {
                    _tmp94 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp94 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp94 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp94 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp94 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
        ...
        if (gid_x < iter_width) {
            if (gid_y + 7 * (int)blockDim.y < iter_height) {
                float _tmp95 = 0.F;
                {
                    _tmp95 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
                }
                {
                    _tmp95 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
                }
                {
                    _tmp95 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
                }
                {
                    _tmp95 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
                }
                {
                    _tmp95 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
                }
  ...
  BH_L:
    {
        ...
        if (gid_y < iter_height) {
            float _tmp120 = 0.F;
            {
                _tmp120 += 0.0289949998F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp120 += 0.103817999F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp120 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp120 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp120 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 1 * (int)blockDim.y < iter_height) {
            float _tmp121 = 0.F;
            {
                _tmp121 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp121 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp121 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp121 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp121 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 2 * (int)blockDim.y < iter_height) {
            float _tmp122 = 0.F;
            {
                _tmp122 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp122 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp122 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp122 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp122 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 3 * (int)blockDim.y < iter_height) {
            float _tmp123 = 0.F;
            {
                _tmp123 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp123 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp123 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp123 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp123 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 4 * (int)blockDim.y < iter_height) {
            float _tmp124 = 0.F;
            {
                _tmp124 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp124 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp124 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp124 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp124 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 5 * (int)blockDim.y < iter_height) {
            float _tmp125 = 0.F;
            {
                _tmp125 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp125 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp125 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp125 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp125 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 6 * (int)blockDim.y < iter_height) {
            float _tmp126 = 0.F;
            {
                _tmp126 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp126 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp126 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp126 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp126 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        if (gid_y + 7 * (int)blockDim.y < iter_height) {
            float _tmp127 = 0.F;
            {
                _tmp127 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp127 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp127 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp127 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp127 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
  ...
  BH_NO:
    {
        ...
        __syncthreads();
        {
            float _tmp128 = 0.F;
            {
                _tmp128 += 0.0289949998F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp128 += 0.103817999F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp128 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp128 += 0.288026005F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp128 += 0.223173007F * _smeminput[(int)threadIdx.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp129 = 0.F;
            {
                _tmp129 += 0.0289949998F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp129 += 0.103817999F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp129 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp129 += 0.288026005F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp129 += 0.223173007F * _smeminput[(int)threadIdx.y + 1 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp130 = 0.F;
            {
                _tmp130 += 0.0289949998F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp130 += 0.103817999F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp130 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp130 += 0.288026005F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp130 += 0.223173007F * _smeminput[(int)threadIdx.y + 2 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp131 = 0.F;
            {
                _tmp131 += 0.0289949998F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp131 += 0.103817999F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp131 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp131 += 0.288026005F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp131 += 0.223173007F * _smeminput[(int)threadIdx.y + 3 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp132 = 0.F;
            {
                _tmp132 += 0.0289949998F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp132 += 0.103817999F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp132 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp132 += 0.288026005F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp132 += 0.223173007F * _smeminput[(int)threadIdx.y + 4 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp133 = 0.F;
            {
                _tmp133 += 0.0289949998F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp133 += 0.103817999F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp133 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp133 += 0.288026005F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp133 += 0.223173007F * _smeminput[(int)threadIdx.y + 5 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp134 = 0.F;
            {
                _tmp134 += 0.0289949998F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp134 += 0.103817999F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp134 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp134 += 0.288026005F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp134 += 0.223173007F * _smeminput[(int)threadIdx.y + 6 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
        ...
        }
        {
            float _tmp135 = 0.F;
            {
                _tmp135 += 0.0289949998F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -3 + 32];
            }
            {
                _tmp135 += 0.103817999F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -2 + 32];
            }
            {
                _tmp135 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + -1 + 32];
            }
            {
                _tmp135 += 0.288026005F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 0 + 32];
            }
            {
                _tmp135 += 0.223173007F * _smeminput[(int)threadIdx.y + 7 * (int)blockDim.y + 0 + 0][(int)threadIdx.x + 1 + 32];
            }
